...
public class ProfFeedbackMenu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View v) {
                ...
                ref.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        if (Float == null) {
                            Intent intent = new Intent(ProfFeedbackMenu.this, CreateFeedBackForm.class);
                            startActivity(intent);
                        } else if (Float.equals("1")) {
                            Toast.makeText(ProfFeedbackMenu.this, "Feedback Form for this already exists", Toast.LENGTH_LONG).show();
                        } else {
                            Intent intent = new Intent(ProfFeedbackMenu.this, CreateFeedBackForm.class);
                            startActivity(intent);
                        }
        ...
        view.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ProfFeedbackMenu.this, pieChart.class);
                startActivity(intent);
            }
        });
    }
