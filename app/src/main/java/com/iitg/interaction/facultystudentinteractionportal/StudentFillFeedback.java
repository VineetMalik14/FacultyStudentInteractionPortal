...
//                        //k = 0;
                ...
                //Toast.makeText(getApplicationContext(),"selected(i)  - "+Integer.toString(selected.get(i))+" ---- selectedradio(i) - "+Integer.toString(selectedradio.get(i)), Toast.LENGTH_SHORT).show();
            }
        });
